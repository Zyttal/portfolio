  ...
  <div className="container mx-auto px-8 lg:px-8 max-w-[1600px] py-12">
    <div className="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-8 lg:gap-12">
      <div className="w-full">
        ...
        <div className="flex flex-row lg:flex-col w-full lg:gap-0 overflow-x-scroll lg:overflow-visible scroll-smooth snap-x snap-mandatory no-scrollbar">
          ...
          {experiences.map((exp, index) => (
            <motion.div
              ...
              className={`shrink-0 snap-start flex items-center cursor-pointer group text-xl lg:text-2xl py-8 px-6 lg:flex-shrink lg:border-l-4 border-b-4 lg:border-b-0 transition-all duration-300 ease-in-out ${
                selectedId === exp.id
